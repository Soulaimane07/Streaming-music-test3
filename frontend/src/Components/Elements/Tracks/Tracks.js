    ...
    return (
        ...
        >
            <div className='px-6 py-4  text-right w-14 flex items-center'>
              {hover !== id 
                ? <span className='opacity-70 absolute transition-opacity duration-200'> {id + 1} </span> 
                : <span className='opacity-100 absolute transition-opacity duration-200'> <FaPlay size={12} /> </span>
              }
            </div>
